...
```text
/thearray/git/moe-mla/.venv-mage-flow-fa4
```
...
```json
{
  ...
  "encoder_cache_dir": "/thearray/git/moe-mla/caches/mage_flow_encoders",
...
```bash
MAGE_FLOW_VENV=/thearray/git/moe-mla/.venv-mage-flow-fa4 \
  /thearray/git/moe-mla/.venv-mage-flow-fa4/bin/python \
