...
```bash
go -C /thearray/git/moe-mla/dashboard2 run ./cmd/trainboard      # dev
go -C /thearray/git/moe-mla/dashboard2 build -o trainboard ./cmd/trainboard
go -C /thearray/git/moe-mla/dashboard2 vet ./...
```
