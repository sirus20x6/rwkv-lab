...
def main():
    ...
    ap.add_argument("--data", default="/workspace/git/babyllm/data/cache/qwen3.6_fwedu_train")
    ...
    if not args.dry_run:
        ...
        print(f"Assemble: python assemble_looped.py --out Qwen3.5-9B-RWKV/rwkv_layers_isolated.pt "
