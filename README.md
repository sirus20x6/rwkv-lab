...
Pexels and Midjourney evaluation rows are queued first; adult, Community Gallery, and Joy
rows are excluded.
...
python -m rwkv_lab.recursive_improve \
  ...
  --proposal-command '/workspace/git/adamaton/bin/propose-rwkv-tasks' \
  --verifier-command '/workspace/git/adamaton/bin/verify-rwkv-batch' \
