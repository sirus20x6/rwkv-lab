...
# dashboard/instrumented/ copy adds only the sys.path shim to run from its subdir.)
import signal
...
def build(args):
    ...
    from . import layer_swap
    from . import rwkv8_deltanet as _r8
...
def train(args):
    ...
    from . import distill_objectives as do
...
def main():
    ...
    ap.add_argument("--control-db",
                    default="dashboard/trainboard.db",
