...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--moon-cache", default="/workspace/downloads/cache/moe-mla/moonvit_next_128_shard_000_ocr10")
    parser.add_argument("--fusion-cache", default="/workspace/downloads/cache/moe-mla/fusion_so400m_next_128_shard_000_ocr10")
