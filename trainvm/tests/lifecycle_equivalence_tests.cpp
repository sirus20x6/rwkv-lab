...
void every_adapter_admits_exactly_what_it_declares() {
  ...
  require(profiles.size() == 16U,
          "the contract registers the complete sixteen-adapter catalog");
...
void compatible_adapters_do_not_claim_exact_resume() {
  ...
  require(compatible == 13U,
          "thirteen registered adapters resume from a compatible checkpoint");
}
