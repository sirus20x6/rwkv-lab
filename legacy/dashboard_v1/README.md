...
```bash
/workspace/git/moe-mla/.venv/bin/python /workspace/git/moe-mla/dashboard/app.py
```
...
- **Sidebar**: all runs under `/workspace/git/moe-mla/runs/`, sorted by last-update. Click a run to load it.
- **Main panel**:
...
Installed into `/workspace/git/moe-mla/.venv/`:
