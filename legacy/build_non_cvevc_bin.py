"""
Merge all Qwen-tokenized .bin files under /workspace/data/formatted_tokens/
EXCLUDING anything under cvevc/, into a single uint32 stream.

Result: /workspace/data/non_cvevc_tokens.bin
Manifest: /workspace/data/non_cvevc_tokens.bin.manifest.json
...
SRC_ROOT = Path("/workspace/data/formatted_tokens")
OUT_BIN = Path("/workspace/data/non_cvevc_tokens.bin")
