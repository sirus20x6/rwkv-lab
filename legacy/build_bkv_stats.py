...
Usage:
    python build_bkv_stats.py \\
        ...
        --out /workspace/git/moe-mla/converted/bkv_stats.pt

    # Then convert with BKV:
    python convert.py --bkv-stats /workspace/git/moe-mla/converted/bkv_stats.pt \\
...
def main() -> None:
    ...
    ap.add_argument("--tokens-bin", default="/workspace/data/non_cvevc_tokens.bin")
    ...
    ap.add_argument("--out", default="/workspace/git/moe-mla/converted/bkv_stats.pt")
    args = ap.parse_args()
