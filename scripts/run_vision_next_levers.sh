...
MOON_CACHE="${VISION_NEXT_MOON_CACHE:-/thearray/downloads/cache/moe-mla/moonvit_next_${PREFIX}_shard_000_ocr10}"
FUSION_CACHE="${VISION_NEXT_FUSION_CACHE:-/thearray/downloads/cache/moe-mla/fusion_so400m_next_${PREFIX}_shard_000_ocr10}"
