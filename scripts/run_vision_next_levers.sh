...
MOON_CACHE="${VISION_NEXT_MOON_CACHE:-/workspace/downloads/cache/moe-mla/moonvit_next_${PREFIX}}"
FUSION_CACHE="${VISION_NEXT_FUSION_CACHE:-/workspace/downloads/cache/moe-mla/fusion_so400m_next_${PREFIX}}"
