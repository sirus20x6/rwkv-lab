...
TRAIN="${VISION_NEXT_TRAIN:-curated_vision/vision_next_shard_000_ocr10_train.jsonl}"
EVAL="${VISION_NEXT_EVAL:-curated_vision/vision_next_shard_000_ocr10_eval.jsonl}"
...
RUN="${VISION_NEXT_RUN:-runs/moonvit_rwkv_next_levers_so400m_ocr10_${PREFIX}}"
MOON_CACHE="${VISION_NEXT_MOON_CACHE:-/workspace/downloads/cache/moe-mla/moonvit_next_${PREFIX}_shard_000_ocr10}"
FUSION_CACHE="${VISION_NEXT_FUSION_CACHE:-/workspace/downloads/cache/moe-mla/fusion_so400m_next_${PREFIX}_shard_000_ocr10}"
RECEIPT="${VISION_NEXT_CACHE_RECEIPT:-curated_vision/vision_next_so400m_${PREFIX}_shard_000_ocr10.cache.json}"
