...
RUN = ROOT / "runs/moonvit_rwkv_i1_community_gallery_phase2"
DATA = ROOT / "datasets/i1_full_sources"
TRAIN_SCRIPT = "./scripts/run_vision_i1_next.sh"
EVAL_MANIFEST = ROOT / "curated_vision/vision_next_i1_community_gallery_eval.jsonl"
...
LAUNCHER_CONTRACTS = {
    "run_vision_i1_next.sh": (
        "runs/moonvit_rwkv_i1_community_gallery_phase2",
