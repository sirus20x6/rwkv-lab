...
while true; do
  ...
  python -m rwkv_lab.vision_train \
      ...
      joy,community_gallery,restricted,private_web,manga,pose_vr,grid --eval-sample-max-new \
      768 --eval-samples \
      14 --feature-cache \
      /workspace/downloads/cache/moe-mla/radio1d_captioning_first --feature-cache-max-bytes \
