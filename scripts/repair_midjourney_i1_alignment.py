...
def update_summary_hashes() -> None:
    specs = {
        ...
        ROOT / "curated_vision/vision_next_i1_community_gallery.summary.json": {
            "train_sha256": ROOT / "curated_vision/vision_next_i1_community_gallery.jsonl",
            "eval_sha256": ROOT / "curated_vision/vision_next_i1_community_gallery_eval.jsonl"},
