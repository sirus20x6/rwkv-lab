...
def grid_rows():
    root = ROOT / "restricted-video-still-caption-grid-only/extracted"
...
def anime_rows():
    root = ROOT / "restricted_scene_animes_31-03/extracted"
...
def manga_rows():
    source = ROOT / "RESTRICTED_Manga/manga_all.parquet"
