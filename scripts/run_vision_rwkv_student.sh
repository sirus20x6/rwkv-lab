...
exec .venv/bin/python -m rwkv_lab.vision_rwkv_student_train \
  ...
  --moon-cache /workspace/downloads/cache/moe-mla/moonvit_next_128_shard_000_ocr10 \
  --fusion-cache /workspace/downloads/cache/moe-mla/fusion_so400m_next_128_shard_000_ocr10 \
