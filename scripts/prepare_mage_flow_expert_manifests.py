...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--animation-source", default="tagged_animation_masterpiece")
    parser.add_argument("--animation-caption-provenance", default="tagged_animation_tags")
    parser.add_argument(
...
def split_balanced_animation_holdout(
    ...
    *,
    ...
    """Select a stable SFW/RESTRICTED holdout without depending on input ordering."""
    ...
    for content_class in ("sfw", "restricted"):
        candidates = [
...
def main() -> None:
    ...
    eval_exports = (
        ...
        Export(
            args.animation_eval,
            "animation",
            "tagged_animation_masterpiece",
            "tagged_animation_tags",
        ),
    )
