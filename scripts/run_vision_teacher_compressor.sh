...
MOON_CACHE="${VISION_COMPRESSOR_MOON_CACHE:-/workspace/downloads/cache/moe-mla/moonvit_next_128_shard_000_ocr10}"
FUSION_CACHE="${VISION_COMPRESSOR_FUSION_CACHE:-/workspace/downloads/cache/moe-mla/fusion_so400m_next_128_shard_000_ocr10}"
