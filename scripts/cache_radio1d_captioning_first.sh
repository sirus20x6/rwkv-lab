...
CACHE="${RADIO_CACHE:-/workspace/downloads/cache/moe-mla/radio1d_captioning_first}"
OLD_CACHE="${RADIO_SOURCE_CACHE:-/workspace/downloads/cache/moe-mla/radio1d_eight_hour_grounded}"
